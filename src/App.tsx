    ...
    <div className="page-stack inner-page orders-page">
      ...
      {ordersView === "active" && (!membershipCheckout || cartItems.length > 0) && cartItems.length > 0 && <section className="cart-panel purchase-simulator" id="checkout" tabIndex={-1}>
        ...
        {(!compactCheckout || checkoutStep === 1) && <div className="checkout-step checkout-cart-step">
          ...
          <div className="checkout-add-course"><div><p className="eyebrow">{t("purchaseSimulator.addAnotherCourseEyebrow")}</p><strong>{t("purchaseSimulator.addAnotherCourseTitle")}</strong><p>{t("purchaseSimulator.addAnotherCourseCopy")}</p></div><Link className="secondary-button small" to="/courses"><Music2 size={16} /> {t("purchaseSimulator.addAnotherCourseAction")} <ArrowUpRight size={15} /></Link></div>
